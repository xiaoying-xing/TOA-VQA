...
'''
result = {}
pred = json.load(open('../experiments/test/A-OKVQA/result_prog_cluster16.json'))
for line in pred:
    result[line['question_id']] = line['answer']

with open('../experiments/test/A-OKVQA/result_prog_cluster16_dict.json', 'w') as f:
    json.dump(result, f)